...
\subsection{Notes}
\begin{itemize}
    \item Multiple Forces on Bodies: The greater the $F_T + F_f$, the more likely to run out of gas because of newton's law of inertia.
...
friction ($\mu$) is $7\times 10^{-1}$. After the car reaches the bottom of the hill, it falls
off of a cliff $64.9$ m high.
...
running out of gas. The coefficient of friction ($\mu$) is $8.9\times 10^{-1}$.
...
\begin{enumerate}[label=\alph*)]
    ...
    \item What is the velocity of the moving blue vehicle? caz
...
The gravitational pull on Titan is $...$. The boulder slides down the hill at a
