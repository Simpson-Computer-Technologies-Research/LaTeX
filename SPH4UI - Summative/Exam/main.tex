...
off of a cliff $64.9$ m high at an angle relative to the hill's with a uniform horizontal velocity.
...
\noindent\textbf{Solve for each of the following:}
\begin{enumerate}[label=\alph*)]
    \item What is the acceleration of the trolley system?
...
\begin{minipage}{0.6\textwidth}
    ...
    Michael falls to the ground and luckily lands on a trampoline that has a spring constant of $430.1\frac{N}{m}$.
    The trampoline compresses $0.18\;m$ before bouncing back to its original height. The trampoline's original height is $0.2\;m$.
\end{minipage}
\hspace{5pt}
\begin{minipage}{0.3\textwidth}
...
\begin{enumerate}[label=\alph*)]
    ...
    \item What is the velocity of Michael after bouncing back from the trampoline?
\end{enumerate}\leavevmode
...
collision, and roll for $2.12$ seconds. The soil at the bottom of the hill has a coefficient of
friction ($\mu$) of $0.42$.
...
Monochromatic light is shone through two slits $4.0 \times 10^5$ nm apart. The fringes on the screen are $d \times 5 \times 10^3$ m away from the slits and have a central maxima width of $2.0 \times 10^{-4}$ km. What is the wavelength of the light? What color would the light be?
