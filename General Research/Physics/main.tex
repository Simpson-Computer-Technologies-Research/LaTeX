...
Wave-particle duality is the idea that all light and matter is both a particle and a wave. This is because although all light and matter is made up of particles (photons, protons, neutrons, electrons, etc.) (particle aspect), the flow of it's particles make up a wave (wave aspect).
...
The equation for gravitational time dilation is $\Delta t\prime = \Delta t\div\sqrt{(1-\frac{2GM}{rc^2})}$ where $\Delta t\prime$ is the time dilation, $\Delta t$ is the time in reference (i.e. an hour), $G$ is the gravitational constant, $M$ is the mass of the object, $r$ is the distance from the object to the center of the object, and $c$ is the speed of light.\\\\
...
To solve for the gravitational time dilation of a black hole we can use the same formula: $\Delta t\prime = \Delta t\div\sqrt{(1-\frac{2GM}{rc^2})}$ except we increase the Schwarzschild radius ($R_{S}$) by a small amount to accompany the requisite of being in a vacuum of space for our equation to be valid. In this case we're going to increase the radius from $2.95 \times 10^{3}\; m \to 3.00 \times 10^{3}\; m$.
\vspace{-0.2cm}
\begin{align*}
    \Delta t\prime & = \Delta t\div\sqrt{(1-\frac{2GM}{rc^2})}                                                                          \\
                   & = 1\; hour \div\sqrt{(1-\frac{2(6.67 \times 10^{-11})(1.989\times 10^{30})}{(3.00 \times 10^{3})(299,792,458)^2})} \\
                   & \approx 1\div\sqrt{1.592\times10^{-2}}                                                                             \\
                   & \approx 1\div1.26 \times 10^{-1}                                                                                   \\
                   & \approx 7.924\;hours
\end{align*}
Therefore for one hour on the outards of a black hole, $\approx 7.924$ hours pass on earth.
...
\vspace{-0.1cm}
\begin{align*}
    \therefore\;\; \Delta t\prime & = \left(\Delta t \div \sqrt{1 - \frac{c^2}{c^2}}\right) = \left(1\div\frac{1}{\sqrt{1 - 1}}\right) = \left(1\div\frac{1}{\sqrt{0}}\right) \\
                                  & = 0\;hours
\end{align*}
Therefore, 0 hours (no time) on earth had passed whilst the object travelled for one hour inside the black hole.
