...
A Circularly polarized wave radiates energy in a horizontal plane, vertical plane and any other possible plane. Circularly polarized lenses grant us access to all the components of a wave instead of just one if using a linearly polarized lens.\\\\
