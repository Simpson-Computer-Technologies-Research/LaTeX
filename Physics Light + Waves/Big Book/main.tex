...
When a wave hits a fixed end, the reflecting wave (phase) is inverted. When a wave hits a free end, the reflecting wave is originially oriented. When a wave hits either a fixed or free end, the wave does NOT get transmitted (no wave on the other side).\\
...
\subsection{Fast to Slow Mediums}
...
\end{itemize}
\subsection{Slow to Fast Mediums}
The transmitted wave is ALWAYS originally oriented!
\begin{itemize}
