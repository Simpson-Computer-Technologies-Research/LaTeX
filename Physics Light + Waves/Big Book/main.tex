...
\end{itemize}\leavevmode
\subsection*{Solve}
To solve for the width of the pattern of eight bright fringes, we must first solve for the distance between two ($\Delta x$). After solving for $\Delta x$ we can multiply it's value by seven to get the final distance. We multiply it by 7 because there are 7 $\Delta y$'s from fringes 1 to 8.\\
\begin{align*}
     ...
     & \therefore\;\;The\;width\;of\;the\;pattern\;of\;eight\;bright\;fringes\;is\;approximately\;2.4 \times 10^{-1}\;m
\end{align*}\leavevmode\\
