...
Since a polarization lens acts as a film (and medium) (air $\to$ lens $\to$ air, fast $\to$ slow $\to$ fast), the transmitted wave loses half of it's amplitude (The phase wave holding it's other half. Refer to \cref{sec:mediums}). This results in $50\%$ of the light being lost.
