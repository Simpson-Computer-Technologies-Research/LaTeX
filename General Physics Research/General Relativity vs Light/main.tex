...
We can assume that our velocity inside a black hole is equal to $c$ since the velocity of an object inside a black hole is equal to the speed of light. This leaves us with:\\
\vspace{-0.2cm}
\begin{minipage}{0.5\textwidth}
    \begin{align*}
