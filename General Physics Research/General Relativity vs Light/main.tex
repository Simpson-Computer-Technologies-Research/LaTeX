...
After solving for the Schwarzschild radius, we can subtitute it into Isaac Newtons law of universal gravitational equation.
\begin{align*}
...
The equation for gravitational time dilation is $\Delta t\prime = \Delta t\times\sqrt{(1-\frac{2GM}{rc^2})}$ where $\Delta t\prime$ is the time dilation, $\Delta t$ is the time in reference (i.e. an hour), $G$ is the gravitational constant, $M$ is the mass of the object, $r$ is the distance to the center of the object, and $c$ is the speed of light. Since we know that the mass of the singularity is infinite, we can substitute it in for $M$ and solve for the time dilation. Like stated above $\infty$ is not quantifyable, therefore, the time dilation ($\Delta t\prime$) is infinite.

\subsubsection{Gravitational Time Dilation of a Black Hole's Event Horizon}
To solve for the gravitational time dilation of a black hole's event horizon we can use the same formula: $\Delta t\prime = \Delta t\times\sqrt{(1-\frac{2GM}{rc^2})}$ where $\Delta t\prime$ is the time dilation, $\Delta t$ is the time in reference (i.e. an hour), $G$ is the gravitational constant, $M$ is the mass of the object, $r$ is the distance to the center of the mass, and $c$ is the speed of light. Since we know that the mass of the black hole is $1.989\times 10^{30}$ kg, we can substitute it in for $M$ and solve for the time dilation. \leavevmode
\vspace{-0.2cm}
\begin{align*}
...
We can assume that our velocity inside a black hole is equal to $c$ since the velocity of an object inside the black hole is equal to the speed of light. This leaves us with:\\
\vspace{-0.2cm}
\begin{minipage}{0.5\textwidth}
    \begin{align*}
