...
You can't because spacetime is so warped from the sheer mass of the black hole that any direction the light tries to go to, it all just points back to the center. (clear this up later using the quora link). Light does not slow down because of the gravitational force being exerted on it (from the black hole's mass). This means that light always stays it's constant.
